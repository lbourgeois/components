...
public class FilterRowDoFnTest {
    ...
    private void runSimpleTestValidSession(FilterRowProperties properties) throws Exception {
        FilterRowDoFn function = new FilterRowDoFn(new ElementValidator()).withProperties(properties) //
        ...
        function = new FilterRowDoFn(new ElementValidator()).withProperties(properties) //
